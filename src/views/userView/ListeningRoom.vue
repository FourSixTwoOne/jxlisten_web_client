<template>  
    <div class="music-room">  
      ...
      <div class="room-content">  
        <div class="chat-area">  
          ...
          <el-input v-model="newMessage" placeholder="输入信息…" @keyup.enter="sendMessage"></el-input>  
        ...
        <div class="player-area">  
          <div class="player-controls">  
            ...
            <div class="controls">  
              <el-button @click="prevSong" icon="el-icon-backward" class="control-btn"></el-button>  
              <el-button @click="togglePlay" :icon="isPlaying ? 'el-icon-pause' : 'el-icon-play'" class="control-btn"></el-button>  
  ...
  const playlist = ref([  
    { title: 'Song 1', artist: 'Artist 1', cover: '@/assets/song1.jpg', duration: 240, url: '@/assets/song1.mp3' },  
    { title: 'Song 2', artist: 'Artist 2', cover: '@/assets/song2.jpg', duration: 180, url: '@/assets/song2.mp3' },  
    { title: 'Song 3', artist: 'Artist 3', cover: '@/assets/song3.jpg', duration: 210, url: '@/assets/song3.mp3' },  
  ]);  
  ...
  // 监听当前歌曲索引变化  
  watch(() => currentSongIndex.value, (newIndex) => {  
