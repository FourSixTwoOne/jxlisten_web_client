    ...
    <div class="profile-container">
        ...
        <el-tabs model-value="activeTab" @tab-click="handleTabClick">
            <el-tab-pane label="收藏歌曲" name="favorites">
                <ul class="song-list">
                    <li v-for="song in user.favoriteSongs" :key="song.id" class="song-item">
            ...
            <el-tab-pane label="好友列表" name="friends">
                <ul class="friend-list">
                    <li v-for="friend in user.friends" :key="friend.id" class="friend-item">
            ...
            <el-tab-pane label="听歌记录" name="history">
                <ul class="history-list">
                    <li v-for="record in user.listenHistory" :key="record.id" class="history-item">
